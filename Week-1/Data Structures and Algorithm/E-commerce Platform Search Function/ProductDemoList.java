public class ProductDemoList {
    ...
    public void StoreItem() {
        ...
        products[3] = new Product(4, "Jeans", "Fashion");
        products[4] = new Product(5, "Stove", "Kitchen");
        products[5] = new Product(6, "Bat", "Sports");
        products[6] = new Product(7, "Swimming Glasses", "Sports");
        products[7] = new Product(8, "Maida", "Grocery");
        products[8] = new Product(9, "Rice", "Grocery");
        products[9] = new Product(10, "Watch", "Electronics");
    ...
    public void displayProduct(int productId) {
        ...
        System.out.println(
                "Name : " + products[productId].getProductName() + " Category : " + products[productId].getCategory());
    }
}
